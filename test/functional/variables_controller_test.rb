...
class VariablesControllerTest < ActionController::TestCase
  ...
  test "should create variable" do
    assert_difference('Variable.count') do
      post :create, variable: { format: @variable.format, maximum: @variable.maximum, minimum: @variable.minimum, multiple: @variable.multiple, question_id: @variable.question_id }
    end
  ...
  test "should update variable" do
    put :update, id: @variable, variable: { format: @variable.format, maximum: @variable.maximum, minimum: @variable.minimum, multiple: @variable.multiple, question_id: @variable.question_id }
    assert_redirected_to variable_path(assigns(:variable))
  end
